...
import { addAppstoDB,getStoredApp } from "../../utilities/localhost";
  ...
  return (
    <div className="w-11/12 mx-auto space-y-5 py-20">
      ...
      <div className="flex lg:flex-row flex-col gap-5 items-stretch">
        ...
        <div className="flex-2">
          <div className="space-y-3 border-b-2 pb-4 border-secondary">
            ...
            <p>
              Developed by{" "}
              <span className="text-secondary font-medium">ItsJihad</span>
            </p>
          </div>
      ...
      <div>
        ...
        <div className="text-justify space-y-3 opacity-60">{description}</div>
      </div>
    </div>
  );
}
